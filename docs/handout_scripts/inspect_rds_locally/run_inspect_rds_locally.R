...
param$data = "/mnt/ngsnfs/single_cell_dev/scRNAseq_processing/sc_analysis/output/2024_040069_1/cluster_analysis/data/sc.rds"
# Output path (only needed for saving plots)
param$path_out = "/mnt/ngsnfs/single_cell_dev/scRNAseq_processing/sc_analysis/output/2024_040069_1/additional_visualisation/"
