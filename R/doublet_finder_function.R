# Functions ===================================================================
# from https://rpubs.com/eileenowens/doubletfinder
...
run_doubletfinder_custom <- function(seu_sample_subset, multiplet_rate = NULL){
  ...
  if(is.null(multiplet_rate)){
    ...
    multiplet_rates_10x <- data.frame(#'Multiplet_rate'= c(0.004, 0.008, 0.0160, 0.023, 0.031, 0.039, 0.046, 0.054, 0.061, 0.069, 0.076, 0.1),
                                      #'Loaded_cells' = c(800, 1600, 3200, 4800, 6400, 8000, 9600, 11200, 12800, 14400, 16000, 20000),
                                      #'Recovered_cells' = c(500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 12500)
                                      'Multiplet_rate'= c(0.004, 0.008, 0.0160, 0.024, 0.032, 0.04, 0.048, 0.056, 0.064, 0.072, 0.08, 0.088, 0.096),
                                      'Loaded_cells' = c(825, 1650, 3300, 4950, 6600, 8250, 9900, 11550, 13200, 14850, 16500, 18150, 19800),
                                      'Recovered_cells' = c(500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000))
