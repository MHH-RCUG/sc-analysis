...
p_umap = LabelClusters(p_umap, id="seurat_clusters", box=TRUE, segment.color="black", fill="white")
...
p2 = LabelClusters(p2, id="seurat_clusters", box=TRUE, segment.color="black", fill="white")
...
```{r umap_by_cluster_separately, fig.height=fig_standard2_height}
