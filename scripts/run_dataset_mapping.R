...
# set project name
param$project_id = "BG-HFO_vs_HFO"

# set reference object
param$refdata = "/mnt/ngsnfs/single_cell_dev/scRNAseq_processing/sc_analysis/data/HFO/sc.rds"
# set query object
...
# Set colors
#param_advset$col_annotation_ref = c('Cluster 1-CM' = "#99e600FF", 'Cluster 3-Mesenchyme' = "#99e6e6FF", 'Cluster 4-Liver' = "#e6b800FF",
#                             'Cluster 6-Apoptotic' = "#000000FF", 'Cluster 2-AFE' = "#99BBFFFF", 'Cluster 7-ECs-Blood' = "#ffff1aFF", 
#                             'Cluster 5-hPSCs' = "#CFCFCFFF")
#param_advset$col_annotation = c('EPP' = "#4682B4FF", 'VE' = "#E6CCFFFF", 'PE/ST' = "#EEC900FF", 'MES' = "#CFCFCFFF", 
...
#param_advset$pc_n = 13
#param_advset$umap_k = 30
